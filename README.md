...
<br />ref: [custom_dataset_training.md](https://github.com/open-mmlab/mmaction2/blob/main/configs/skeleton/posec3d/custom_dataset_training.md)
<br />========================================
...
```
Download **Base & Pose Detection Config Script** and save to the proper directory:
```
