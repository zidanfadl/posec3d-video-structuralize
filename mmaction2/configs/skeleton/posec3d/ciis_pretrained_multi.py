...
train_pipeline = [
    ...
    dict(
        ...
        with_limb=True),  # Generate pseudo heatmaps for limbs. At least one of 'with_kp' and 'with_limb' should be True. Default: False.
...
train_cfg = dict(
    type='EpochBasedTrainLoop', max_epochs=30, val_begin=5, val_interval=5)
...
optim_wrapper = dict(
    optimizer=dict(type='SGD', lr=0.05, momentum=0.9, weight_decay=0.003),
