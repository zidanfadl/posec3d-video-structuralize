...
# load_from='../../../../work_dirs/ciis_not-multi_no-berdiri_1-1_best-200/epoch_310.pth'
...
ann_file = 'data/skeleton/ciis_0s7_v3.pkl'  # changed for ciis
...
train_cfg = dict(
    type='EpochBasedTrainLoop', max_epochs=2240, val_begin=10, val_interval=10)
...
param_scheduler = [
	...
	# the restarts.
        eta_min=0,
        T_max=4480,  # https://www.youtube.com/watch?v=WgwBRqhdIrQ&t=468s
        by_epoch=True,
