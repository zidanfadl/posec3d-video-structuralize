ann_file = 'data/skeleton/ciis_0s7_no-berdiri.pkl'
...
train_cfg = dict(
    max_epochs=960, type='EpochBasedTrainLoop', val_begin=10, val_interval=10)
...
work_dir = 'work_dirs/ciis_not-multi_no-berdiri_1-2'
